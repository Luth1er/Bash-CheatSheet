...
sudo nmap -sV --script smtp-open-relay -v <target>
...
sudo nmap -p25 –script smtp-enum-users <target>
...
sudo nmap -sV --script smtp-strangeport <target>
...
sudo nmap -p 25 --script smtp-brute <target>
...
sudo nmap -p110 --script pop3-capabilities <target>
...
sudo nmap -p 110 --script pop3-brute <target>
...
sudo nmap -p143,993 --script imap-capabilities <target>
...
sudo nmap -p 143 --script imap-brute <target>
